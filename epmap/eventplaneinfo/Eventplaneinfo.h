...
class Eventplaneinfo : public PHObject
{
 public:
  ...
  virtual void set_flowvector(std::vector<std::pair<double,double>> /*Qvec*/) {return;}
  virtual std::pair<double, double> get_flowvector(int /*order*/) const {return std::make_pair(NAN, NAN);}
